...
#download img
path_sound = resource_path('hit_sound.mp3')
sound = pygame.mixer.music.load(path_sound)


path_road = resource_path('road.png')
road = pygame.image.load(path_road)

path_nar = resource_path('naruto.png')
nar = pygame.image.load(path_nar)
nar = pygame.transform.scale(nar, (40, 45))
nar_hp = pygame.transform.scale(nar, (20, 23))

paht_car1 = resource_path('car_up.png')
car1 = pygame.image.load(paht_car1)
car1 = pygame.transform.scale(car1, (60, 110))

path_car2 = resource_path('car_down.png')
car2 = pygame.image.load(path_car2)
car2 = pygame.transform.scale(car2,(60,110))

path_car_hp = resource_path('HP_car.png')
car_hp = pygame.image.load(path_car_hp)
